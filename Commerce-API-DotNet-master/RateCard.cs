...
namespace Microsoft.Partner.CSP.Api.V1.Samples
{
    class RateCard
    {
        ...
        public static dynamic GetRateCard(string resellerCid, string sa_token, string correlationId)
        {

            var request = (HttpWebRequest)HttpWebRequest.Create(string.Format("https://api.cp.microsoft.com/{0}/rate-card?&OfferDurableId=MS-AZR-0146P", resellerCid));

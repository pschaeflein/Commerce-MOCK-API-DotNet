...
namespace Microsoft.Partner.CSP.Api.V1.Samples
{
	...
	public static class Customer
	{
		...
		public static string GetCustomerCid(string customerMicrosoftId, string resellerMicrosoftId, string sa_Token)
		{
			...
			var request = (HttpWebRequest)HttpWebRequest.Create(string.Format("http://localhost:59080/customers/get-by-identity?provider=AAD&type=external_group&tid={0}&etid={1}", customerMicrosoftId, resellerMicrosoftId));
		...
		public static dynamic CreateCustomer(dynamic customer, string resellerCid, string sa_Token)
		{
			...
			var request = (HttpWebRequest)HttpWebRequest.Create(string.Format("http://localhost:59080/{0}/customers/create-reseller-customer", resellerCid));
